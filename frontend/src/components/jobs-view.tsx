          ...
          <div className="mx-auto flex max-w-4xl flex-col gap-4">
            ...
            <div className="rounded-3xl border border-border bg-background/88 p-5 shadow-sm">
              ...
              <div className="mt-4 grid gap-3 lg:grid-cols-3">
                <div className="space-y-3 rounded-2xl border border-border bg-muted/35 p-4 lg:col-span-2">
                ...
                <label className="space-y-1.5 rounded-2xl border border-border bg-muted/35 p-4">
            ...
            <div className="rounded-3xl border border-border bg-background/88 p-5 shadow-sm">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    Optional input for the next manual run.
                  </p>
                </div>
                <button
                  type="button"
              ...
              <label className="mt-4 block space-y-1.5">
                <span className="text-xs font-medium uppercase tracking-[0.14em] text-muted-foreground">Input</span>
                <textarea
                  value={runData}
                  onChange={(event) => setRunData(event.target.value)}
                  placeholder="Optional data for next run."
                  disabled={saving || running}
                  rows={5}
